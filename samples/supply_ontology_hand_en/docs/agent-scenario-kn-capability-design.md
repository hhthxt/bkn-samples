> **Superseded as the pack’s main design (2026-08-13)**  
> This file still describes KN `supplychain_hd0202` (431 products, Kunshan/Xinjiang warehouses). **Do not use it to verify this sample.**  
> Canonical docs (Chinese): [场景驱动的供应链动态能力设计](./场景驱动的供应链动态能力设计.md), [业务问答测试集](./业务问答测试集.md), [Agent导入验证清单](./Agent导入验证清单.md).  
> Operational guide: [openbkn-hand-import-guide.md](./openbkn-hand-import-guide.md).
