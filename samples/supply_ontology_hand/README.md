...
[供应链本体 Handbook HTML](./docs/handbook.html) · [Agent 操作](./docs/agent-operation-guide.md) · [手工操作](./docs/manual-operation-guide.md) · [Playbook](./docs/playbook.md) · [QA 测试集](./docs/qa-eval-set.yaml)
