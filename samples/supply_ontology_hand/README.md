...
| 文档 | 说明 |
|------|------|
| [供应链智能决策 Sample 案例报告（HTML）](docs/handbook.html) | 面向业务负责人和 CIO：业务价值、场景、数据、能力闭环与验证边界 |
...
| [供应链 BKN-Eval](bkn-eval/README.md) | 基于知识网络与直连数据库的核心 50 题对照评测、复现指南和正式报告 |
...
| [OpenBKN 在线体验](docs/quickstart/online-openbkn.md) | 第三方 Agent 通过 MCP 查询知识网络并调用原生函数 |
...
| `native_function_bundle.py` · `register_native_function_toolbox.py` | 8 | 注册 14 个按业务命名的原生函数；函数自行读取知识网络 |
