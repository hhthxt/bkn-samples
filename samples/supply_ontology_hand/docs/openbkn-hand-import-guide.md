...
- Scenario design (optional): `docs/agent-scenario-kn-capability-design.md` · [中文](docs/agent-scenario-kn-capability-design_cn.md)
...
Does not block P0. See [agent-scenario-kn-capability-design.md](./agent-scenario-kn-capability-design.md) ([中文](./agent-scenario-kn-capability-design_cn.md)) for S1–S6 scenarios.
...
Use fixed questions in Agent UI; optionally run smoke script.

| # | Question | Expected |
|---|----------|----------|
| Q1 | How many products in this KN? | Count or list; not “unbound” |
| Q2 | Basic info for product `382-000005` | Name/code returned |
| Q3 | Sales orders for product `382-000005` | SO linkage works |
| Q4 | BOM materials for `382-000005` | Material list |
| Q5 | Kit/backward diagnosis for `382-000005`, need date `2026-05-14` | P0: no empty data; P1: lead time / gap points |
...
Smoke checks KN name, OT row counts, and `join_checks` hit rates; Q5 quality is manual.
