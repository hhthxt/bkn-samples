> **体验包说明（手工版）**  
> 本文原针对 KN `supplychain_hd0202`。在本体验包中请改用：  
> - 网络名称：`供应链本体知识网络-手工版`  
> - 网络 ID：`supply_ontology_hand`  
> - 对象类 ID 前缀：`supply_ontology_hand_*`（具体见 `kn/supply_ontology_hand.json`）  
> 操作主文档：[openbkn-hand-import-guide_cn.md](./openbkn-hand-import-guide_cn.md) · [English](./openbkn-hand-import-guide.md)（同目录，步骤 1～7 唯一入口）。  
